...
// Pre-auth slides — conversion-focused value propositions.
// These are the "why" (problem → solution) that lead into sign-up.
// Post-auth education slides then show the "how" (features in action).
const SLIDES = [
  {
    mockup: 'spending' as const,
    title: 'Your money\nis leaking',
    body: 'Hidden fees, idle savings, overpaid debt — most people lose hundreds a year without knowing.',
    image: IMG_OPTIMISE,
  },
  {
    mockup: 'chat' as const,
    title: 'Bocy finds\nevery fix',
    body: 'Connects to your bank, ranks every saving by impact, and walks you through each one.',
    image: IMG_ASK,
  },
  {
    mockup: 'networth' as const,
    title: 'Watch your\nwealth grow',
    body: 'Track net worth, optimise spending, and build real momentum — all in one place.',
      ...
      <Animated.View style={[styles.bottomArea, {
        ...
        >
          <Text style={styles.buttonText}>
            {isLast ? (SLIDES[currentPage].cta || 'Get started') : 'Next'}
          </Text>
        </TouchableOpacity>
